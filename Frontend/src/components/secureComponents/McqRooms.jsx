...
const McqRooms = () => {
  ...
  return (
    <div className="bg-black/80 text-white font-[Inter] p-5">
      <div className="bg-[#111] shadow-md p-5 rounded-md">
        <div className="flex gap-4 items-center">
          <div className="bg-[#222] px-2 py-2 text-4xl rounded-xl">
            <GiMultipleTargets />
          </div>
          <div>
      ...
      <div className="flex items-center mt-6 justify-center gap-4 text-white">
        <div className="bg-[#111] px-3 py-1 rounded-xl">Solo</div>
        <div className="bg-[#111] px-3 py-1 rounded-xl">Duo</div>
        <div className="bg-[#111] px-3 py-1 rounded-xl">Trio</div>
        <div className="bg-[#111] px-3 py-1 rounded-xl">Squad</div>
        <div className="bg-[#111] px-3 py-1 rounded-xl">Multiverse</div>
      </div>
      ...
      <div className="flex items-center flex-wrap max-w-[900px] mx-auto p-4">
        {quizList.map((elem, idx) => (
          <div
            key={idx}
            className="flex flex-col basis-[48%] border border-white/20 p-2 bg-[#1a1a1a] m-2 rounded-md"
          >
            <h1 className="text-white font-bold m-2">{elem.name}</h1>
            <div className="flex text-gray-300 text-sm gap-4 m-2">
              <p>{elem.Questions} questions</p>
            ...
            <div className="flex justify-between items-center m-2">
              <div className="px-2 py-1 bg-[#333] rounded-lg">
                {elem.button}
              </div>
              <div className="text-white text-sm">*{elem.reward}</div>
            </div>
          </div>
        ))}
      </div>
