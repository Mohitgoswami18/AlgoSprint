...
const Leaderboard = () => {
  ...
  useEffect(async ()=>{
    const response = await axios.get(`https://algosprint-vxi4.onrender.com/api/v1/user/leaderboard`)
      .then((res) => {
        setData(true);
    ...
    leaderboardTop3 = [
      {
        ...
        points: leaderboardData.top10[0]?.currentRating || 0,
        BattleWon: leaderboardData.top10[0]?.totalWins || 0,
      },
      {
        rank: "2",
        ...
        points: leaderboardData.top10[1]?.currentRating || 0,
        BattleWon: leaderboardData.top10[1]?.totalWins || 0,
      },
      {
        rank: "3",
        ...
        points: leaderboardData.top10[2]?.currentRating || 0,
        BattleWon: leaderboardData.top10[2]?.totalWins || 0,
      },
    ];
    leaderboardStats = [
      {
