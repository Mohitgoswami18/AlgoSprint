  ...
  return (
    <section
      className="
        ...
        dark:from-cyan-500/20 dark:via-violet-600/10 dark:to-purple-500/20
        rounded-2xl shadow-xl mx-4 md:mx-auto my-20 max-w-5xl p-10 text-center
    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <button className="px-6 py-3 rounded-full border border-black/20 dark:border-white/20 hover:bg-black/5 dark:hover:bg-white/10 transition-all font-medium text-black dark:text-gray-200">
          Join with Code
        </button>
      </div>
    </section>
